...
public class BlueOne extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
         ...
         * - drive 30centimeters forward (2 sec)
         * - drive to the right until seeing wall (max 50 centimeter) (3 sec)
         * - drive backwards until cryptobox is seen, max 40 centimeters (3 sec)
        ...
        //DRIVE MAX 40 CENTIMETER BACKWARDS AND STOP WHEN SEEING CRYPTOBOX (3 sec)
